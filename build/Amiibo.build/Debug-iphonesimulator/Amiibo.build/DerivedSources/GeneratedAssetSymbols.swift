...
extension ImageResource {
    ...
    static let mario = ImageResource(name: "Mario", bundle: resourceBundle)

    /// The "au" asset catalog image resource.
    static let au = ImageResource(name: "au", bundle: resourceBundle)

    /// The "eu" asset catalog image resource.
    static let eu = ImageResource(name: "eu", bundle: resourceBundle)

    /// The "jp" asset catalog image resource.
    static let jp = ImageResource(name: "jp", bundle: resourceBundle)

    /// The "na" asset catalog image resource.
    static let na = ImageResource(name: "na", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "eu" asset catalog image.
    static var eu: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .eu)
#else
        .init()
